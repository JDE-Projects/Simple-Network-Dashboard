...
copy_application_files() {
    cp main.py config.py ws_manager.py update_check.py runtime_state.py debug_log.py persistence.py metrics_poller.py ssh_manager.py auth.py session_manager.py snd-reset-password requirements.txt uninstall.sh "$APP_DIR/"
