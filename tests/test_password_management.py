...
def test_installer_and_uninstaller_contracts_include_only_the_approved_auth_files() -> None:
    ...
    assert 'cp main.py config.py metrics_poller.py ssh_manager.py auth.py session_manager.py snd-reset-password requirements.txt uninstall.sh "$APP_DIR/"' in installer
