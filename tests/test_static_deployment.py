...
for filename in main.py config.py ws_manager.py update_check.py runtime_state.py metrics_poller.py ssh_manager.py auth.py session_manager.py requirements.txt uninstall.sh; do
